...
class UpdateAdapter(private val ballList: ArrayList<house>, val clickListener: (house, Int) -> Unit): RecyclerView.Adapter<UpdateAdapter.ViewHolder>() {
...
//        val ballAll:ConstraintLayout = view.findViewById(R.id.linearLayout)
        val edit_btn:Button = view.findViewById(R.id.edit)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.update_layout, parent, false)
...
//        holder.ballTel.text = ball.tel
        holder.edit_btn.setOnClickListener { view: View ->
